...
public Karyawan() {
    ...
    Ubah_Karyawan jtRowData = new Ubah_Karyawan();
...
int post = 1;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 760, 480));
        ...
        jPanel1.add(btn_tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 90, 110, 40));
        ...
        jPanel1.add(btn_ubah, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 90, 110, 40));
        ...
        jPanel1.add(btn_hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 90, 110, 40));
        ...
        jPanel1.add(logout_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 20, 110, 40));
    ...
    private void jTableKaryawanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableKaryawanMouseClicked
        ...
        String kode_karyawan = model.getValueAt(index, 0).toString();
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        ...
        jtRowData.txt_kdKaryawan.setText(kode_karyawan);
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        try {
            ...
            String sql = "DELETE FROM karyawan WHERE kode_karyawan ='"+kd_karyawan+"'";
            java.sql.Connection conn = (Connection)Konfigurasi.konfigurasiDB();
