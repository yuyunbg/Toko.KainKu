...
public class Penjualan extends javax.swing.JFrame {
    ...
    Ubah_Penjualan jtRowData = new Ubah_Penjualan();
    ...
    private void load_table(){
        ...
        try {
            String sql = "SELECT penjualan.kode_penjualan, produk.nama_produk, penjualan.waktu, detail_penjualan.jumlah, "
                    ...
                    + "JOIN karyawan on penjualan.kode_karyawan=karyawan.kode_karyawan ORDER BY kode_penjualan asc";
...
int post = 1;
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_ubah, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 110, 110, 40));
        ...
        jPanel1.add(btn_hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 110, 110, 40));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 760, 460));
        ...
        jPanel1.add(btn_tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, 110, 40));
    ...
    private void jTablePenjualanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablePenjualanMouseClicked
        ...
        String kode_penjualan = model.getValueAt(index, 0).toString();
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        ...
        jtRowData.txt_kodepenjualan.setText(kode_penjualan);
        jtRowData.txt_kodepenjualan.disable();
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        try {
            ...
            TableModel model = jTablePenjualan.getModel();
            String kode_penjualan = model.getValueAt(index, 0).toString();
            String sql = "DELETE FROM penjualan WHERE kode_penjualan ='"+kode_penjualan+"'";
            String sql1 = "DELETE FROM detail_penjualan WHERE kode_penjualan ='"+kode_penjualan+"'";
            java.sql.Connection conn = (Connection)Konfigurasi.konfigurasiDB();
